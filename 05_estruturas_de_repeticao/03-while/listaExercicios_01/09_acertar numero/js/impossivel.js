// Jogo de acertar o número - Nível Impossível (1-1000)
document.addEventListener("DOMContentLoaded", () => {
    ...
    tentarBtn.addEventListener("click", () => {
        ...
        if (isNaN(palpite) || palpite < 1 || palpite > 1000) {
            mensagem.textContent = "Por favor, digite um número entre 1 e 1000.";
            return;
        }
    ...
    palpiteInput.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
